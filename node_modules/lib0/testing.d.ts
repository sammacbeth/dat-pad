...
export function group(description: string, f: (arg0: void) => void | Promise<undefined>): Promise<void>;
export function measureTime(message: string, f: () => void | Promise<undefined>): Promise<void>;
