(function () {
  ...
  */
  ...
  const splitSnapshotAffectedStructs = (transaction, snapshot) => {
    const meta = setIfUndefined$1(transaction.meta, splitSnapshotAffectedStructs, create$6);
  ...
  const addChangedTypeToTransaction = (transaction, type, parentSub) => {
    ...
    if (item === null || (item.id.clock < (transaction.beforeState.get(item.id.client) || 0) && !item.deleted)) {
      setIfUndefined$1(transaction.changed, type, create$6).add(parentSub);
    }
  };
  ...
  class Item extends AbstractStruct {
    ...
    delete (transaction) {
      if (!this.deleted) {
        ...
        setIfUndefined$1(transaction.changed, parent, create$6).add(this.parentSub);
