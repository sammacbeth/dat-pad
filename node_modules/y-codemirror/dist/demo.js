(function () {
   ...
   * @param {string} s
   */
  const fromBase64Node$1 = s => new Uint8Array(Buffer.from(s, 'base64').buffer);
  ...
  class WebsocketClient extends Observable$1 {
    ...
    constructor (url, { binaryType } = {}) {
      ...
      this._checkInterval = setInterval(() => {
        if (this.connected && messageReconnectTimeout < getUnixTime$1() - this.lastMessageReceived) {
  ...
  const getChannel = room =>
    setIfUndefined$1(channels, room, () => {
      const subs = new Set();
  ...
  /* istanbul ignore next */
  const utf8TextDecoder$1 = typeof TextDecoder === 'undefined' ? null : new TextDecoder('utf-8', { fatal: true, ignoreBOM: true });
